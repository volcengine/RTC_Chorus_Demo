...
- (void)setModel:(ChorusRoomModel *)model {
    _model = model;
...
- (UIImageView *)iconImageView {
    if (!_iconImageView) {
        ...
        _iconImageView.image = [UIImage imageNamed:@"Chorus_live" bundleName:HomeBundleName];
    }
...
- (UIImageView *)peopleNumImageView {
    if (!_peopleNumImageView) {
        ...
        _peopleNumImageView.image = [UIImage imageNamed:@"Chorus_people" bundleName:HomeBundleName];
    }
