...
1. 打开终端窗口，进入 `ChorusDemo/iOS/RTCSolution` 根目录<br>
...
3. 进入 `ChorusDemo/iOS/RTCSolution` 根目录，使用 Xcode 打开 `RTCSolution.xcworkspace`<br>
...
7. 打开 `Pods/Development Pods/ChorusDemo/ChorusDemoConstants` 文件
...
8. 填写 **HiFiveAppID**、**HiFiveServerCode** 和 **KEY** <br>
    ...
    <img src="https://lf3-static.bytednsdoc.com/obj/eden-cn/pkupenuhr/iosservice.png" width="500px" >
...
2. 登录 Apple ID。
    2.1 选择 Xcode 页面左上角 **Xcode** > **Settings**，或通过快捷键 **Command** + **,**  打开 Settings。
