...
@interface ChorusAvatarComponent ()
...
@implementation ChorusAvatarComponent
...
- (UIImageView *)bgImageImageView {
    if (!_bgImageImageView) {
        ...
        _bgImageImageView.image = [UIImage imageNamed:@"chorus_avatar_bg" bundleName:HomeBundleName];
    }
