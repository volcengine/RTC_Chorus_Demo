...
@interface ChorusIMView ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *roomTableView;

@end

@implementation ChorusIMView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ChorusIMCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ChorusIMCellID" forIndexPath:indexPath];
...
- (UITableView *)roomTableView {
    if (!_roomTableView) {
        ...
        [_roomTableView registerClass:ChorusIMCell.class forCellReuseIdentifier:@"ChorusIMCellID"];
