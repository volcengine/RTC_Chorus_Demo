...
- (void)buttonClick:(UIButton *)button {
    ...
    [button setTitleColor:[UIColor colorFromHexString:@"#EE77C6"] forState:UIControlStateNormal];
...
- (UIButton *)onlineButton {
    if (!_onlineButton) {
        ...
        [_onlineButton setTitle:veString(@"在线曲库") forState:UIControlStateNormal];
        [_onlineButton setTitleColor:[UIColor colorFromHexString:@"#EE77C6"] forState:UIControlStateNormal];
...
- (UIButton *)pickedButton {
    if (!_pickedButton) {
        ...
        [_pickedButton setTitle:veString(@"已点歌曲") forState:UIControlStateNormal];
...
- (UIView *)selectedView {
    if (!_selectedView) {
        ...
        _selectedView.backgroundColor = [UIColor colorFromHexString:@"#EE77C6"];
