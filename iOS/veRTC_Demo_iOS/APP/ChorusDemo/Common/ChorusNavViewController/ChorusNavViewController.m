...
#import "ChorusNavViewController.h"

@interface ChorusNavViewController ()<UIGestureRecognizerDelegate>

@property (nonatomic, strong) UILabel *navLabel;

@end

@implementation ChorusNavViewController
