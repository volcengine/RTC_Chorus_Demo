...
+ (void)startLive:(NSString *)roomName
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcStartLive" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)finishLive:(NSString *)roomID {
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcFinishLive" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
        NSLog(@"[%@]-owcFinishLive %@ \n %@", [self class], dic, ackModel.response);
    }];
}
...
+ (void)requestPickedSongList:(NSString *)roomID
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcGetRequestSongList" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)pickSong:(ChorusSongModel *)songModel
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcRequestSong" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)cutOffSong:(NSString *)roomID
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcCutOffSong" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)finishSing:(NSString *)roomID
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcFinishSing" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)joinLiveRoom:(NSString *)roomID
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcJoinLiveRoom" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)leaveLiveRoom:(NSString *)roomID {
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcLeaveLiveRoom" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)getActiveLiveRoomListWithBlock:(void (^)(NSArray<ChorusRoomModel *> *roomList,
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcGetActiveLiveRoomList" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)sendMessage:(NSString *)roomID
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcSendMessage" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)startSingWithRoomID:(NSString *)roomID
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcStartSing" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)clearUser:(void(^)(RTMACKModel *model))block {
    ...
    [[ChorusRTCManager shareRtc] emitWithAck:@"owcClearUser" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
...
+ (void)onAudienceJoinRoomWithBlock:(void (^)(ChorusUserModel *userModel,
    ...
    [[ChorusRTCManager shareRtc] onSceneListener:@"owcOnAudienceJoinRoom" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onAudienceLeaveRoomWithBlock:(void (^)(ChorusUserModel *userModel,
                                               NSInteger count))block {
    [[ChorusRTCManager shareRtc] onSceneListener:@"owcOnAudienceLeaveRoom" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onFinishLiveWithBlock:(void (^)(NSString *rommID, NSInteger type))block {
    [[ChorusRTCManager shareRtc] onSceneListener:@"owcOnFinishLive" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onMessageWithBlock:(void (^)(ChorusUserModel *userModel,
    ...
    [[ChorusRTCManager shareRtc] onSceneListener:@"owcOnMessage" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onPickSongBlock:(void(^)(ChorusSongModel *songModel))block {
    [[ChorusRTCManager shareRtc] onSceneListener:@"owcOnRequestSong" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onPrepareStartSingSongBlock:(void(^)(ChorusSongModel *_Nullable songModel,
    ...
    [[ChorusRTCManager shareRtc] onSceneListener:@"owcOnWaitSing" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onReallyStartSingSongBlock:(void(^)(ChorusSongModel *songModel,
    ...
    [[ChorusRTCManager shareRtc] onSceneListener:@"owcOnStartSing" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onFinishSingSongBlock:(void(^)(ChorusSongModel *nextSongModel, NSInteger score))block {
    [[ChorusRTCManager shareRtc] onSceneListener:@"owcOnFinishSing" block:^(RTMNoticeModel * _Nonnull noticeModel) {
