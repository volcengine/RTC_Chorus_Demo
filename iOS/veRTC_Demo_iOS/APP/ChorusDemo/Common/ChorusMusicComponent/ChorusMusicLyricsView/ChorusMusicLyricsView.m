...
@interface ChorusMusicLyricsView () <UITableViewDataSource, UITableViewDelegate>

@property (nonatomic, strong) UITableView *tableView;

@property (nonatomic, strong, nullable) ChorusMusicLyricsInfo *lyricsInfo;

@property (nonatomic, assign) NSUInteger currentRow;

@end

@implementation ChorusMusicLyricsView
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [_tableView registerClass:[ChorusMusicLyricsLineCell class]
           forCellReuseIdentifier:[ChorusMusicLyricsLineCell reuseIdentifier]];
...
- (void)loadLrcByPath:(NSString *)path error:(NSError * _Nullable __autoreleasing *)error {
    _lyricsInfo = [ChorusMusicLyricsAnalyzer analyzeLrcByPath:path error:error];
    [self resetStatus];
}

- (void)loadLrcBylrcString:(NSString *)string {
    _lyricsInfo = [ChorusMusicLyricsAnalyzer analyzeLrcBylrcString:string];
    [self resetStatus];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ChorusMusicLyricsLineCell *cell = [tableView dequeueReusableCellWithIdentifier:[ChorusMusicLyricsLineCell reuseIdentifier]
