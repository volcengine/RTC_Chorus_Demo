...
@interface ChorusRoomItemButton ()

@property (nonatomic, strong) UIImageView *redImageView;

@end

@implementation ChorusRoomItemButton
...
- (UIImageView *)redImageView {
    if (!_redImageView) {
        ...
        _redImageView.image = [UIImage imageNamed:@"Chorus_bottom_red" bundleName:HomeBundleName];
