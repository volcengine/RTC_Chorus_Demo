...
- (void)loadDataWithGetLists {
    ...
    [ChorusRTSManager clearUser:^(RTMACKModel * _Nonnull model) {
        [ChorusRTSManager getActiveLiveRoomListWithBlock:^(NSArray<ChorusRoomModel *> * _Nonnull roomList, RTMACKModel * _Nonnull model) {
